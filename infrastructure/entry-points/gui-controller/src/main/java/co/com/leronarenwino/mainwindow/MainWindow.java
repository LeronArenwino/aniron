...
package co.com.leronarenwino.mainwindow;

import co.com.leronarenwino.Multimedia;
import co.com.leronarenwino.PropertiesManager;
import co.com.leronarenwino.Song;

import co.com.leronarenwino.controllers.JukeboxController;
import co.com.leronarenwino.settings.SettingsWindow;
...
import static co.com.leronarenwino.SettingsSingleton.*;
import static co.com.leronarenwino.controllers.JukeboxController.*;
...
public class MainWindow extends JFrame implements Serializable {
    ...
    // Timers
    private Timer timerFocusMainPanel;
    private Timer timerReturnFocus;
    private Timer timerRandomSong;
    private Timer timerRandomPromotionalVideo;
    private Timer timerToFullScreen;
    ...
    private void paintComponents() {
        ...
        musicQueueScrollPanel.setBorder(BorderFactory.createEmptyBorder());
        ...
        songsListScrollPanel.setBorder(BorderFactory.createEmptyBorder());
        ...
        searchSongsListTextField.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 0, Color.decode(light)));
